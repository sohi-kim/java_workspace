/* `제약 조건 constraints`
   ...
   1) Not Null (널 허용 안함. 필수 입력)      2) CHECK (값의 범위)
   3) UNIQUE(유일한 값)   
...
CREATE TABLE tbl_score(
	...
	teacher varchar2(100) NOT NULL ,	-- 담당교사
...
INSERT INTO tbl_score(stuno,subject,jumsu,teacher,term)
VALUES (null,'국어',89,'이나연','2022_1'); 		
		-- 기본키를 구성하는 컬럼은 NULL 허용 못합니다.
...
SELECT * FROM TBL_STUDENT ts WHERE NAME  = '김모모';		-- 추후에 김모모 입력(동명이인) 가능
